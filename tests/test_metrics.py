...
sys.path.append('../seq2seq/metrics/')
...
if __name__ == '__main__':
    ...
    for qid, dinfo in scores.items():
        ...
        ndcg_10 += rank_evaluations.eval_ndcg(y_true=y_true, y_pred=y_pred,
                                              k=10)
        p_5 += rank_evaluations.eval_precision(y_true=y_true, y_pred=y_pred,
                                               k=5)
        p_10 += rank_evaluations.eval_precision(y_true=y_true, y_pred=y_pred,
                                                k=10)
    ...
    'map: ', map / num_valid
    print
    'ndcg@5: ', ndcg_5 / num_valid
    print
    'ndcg@10: ', ndcg_10 / num_valid
    print
    'p@5: ', p_5 / num_valid
    print
    'p@10: ', p_10 / num_valid
