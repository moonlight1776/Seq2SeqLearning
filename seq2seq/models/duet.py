...
class DUET(BasicModel):
    ...
    def build(self):
        ...
        lm_conv = Conv1D(self.config['lm_kernel_count'],
                         self.config['text2_maxlen'], padding='same',
        ...
        dm_q_conv = Conv1D(self.config['dm_kernel_count'],
                           self.config['dm_kernel_size'], padding='same',
        ...
        dm_q_mp = MaxPooling1D(pool_size=self.config['text1_maxlen'])(
            dm_q_conv)
        ...
        dm_d_conv1 = Conv1D(self.config['dm_kernel_count'],
                            self.config['dm_kernel_size'], padding='same',
        ...
        dm_d_conv2 = Conv1D(self.config['dm_kernel_count'], 1, padding='same',
